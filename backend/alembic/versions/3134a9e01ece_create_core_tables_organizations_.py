...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "plan",
            sa.Enum("startup", "mid", "enterprise", name="org_plan"),
    ...
    op.create_index(
        "ix_tts_provider_configs_org_id",
        "tts_provider_configs",
        ["org_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("voice", "text", "form", name="campaign_type"),
            nullable=False,
        ),
        sa.Column(
            "status",
    ...
    op.create_index(
        "ix_interactions_campaign_status",
        "interactions",
        ["campaign_id", "status"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_analytics_events_interaction_id",
        "analytics_events",
        ["interaction_id"],
        unique=False,
    )
