...
def upgrade() -> None:
    ...
    sa.Column('otp_options', sa.Enum('personnel', 'generated', name='otp_type'), nullable=False),
    sa.Column('sms_send_options', sa.Enum('text', 'voice', name='delivery_method'), nullable=False),
