...
export const PALETTE_NODES: PaletteNode[] = [
  ...
  { kind: "enrich_columns", label: "Set Fields", description: "Compute/update columns with expressions", category: "processing" },
  { kind: "response_capture", label: "Wait for Reply", description: "Wait for SMS/DTMF response and branch by outcome", category: "processing" },
  { kind: "dtmf_menu", label: "DTMF Menu", description: "Branch by keypad input digits", category: "processing" },
  ...
  { kind: "agent_voice_interactive", label: "Interactive Voice", description: "Two-way AI voice call", category: "actions" },
  ...
  { kind: "sender_number", label: "Sender Number", description: "Select outbound number", category: "control" },
