    ...
    <header className="sticky top-0 z-40 border-b border-[#E2E8F0] bg-white/85 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 md:px-6">
        <a href="#hero" className="font-display text-2xl tracking-tight">
          Ring <span className="gradient-text">AI</span>
        </a>

        <nav className="hidden items-center gap-6 text-sm text-[#334155] md:flex">
          <a href="#demo" className="hover:text-[#0052FF]">{t.demo}</a>
          <a href="#products" className="hover:text-[#0052FF]">{t.products}</a>
          <a href="#how-it-works" className="hover:text-[#0052FF]">{t.flow}</a>
          <a href="#use-cases" className="hover:text-[#0052FF]">{t.useCases}</a>
          <a href="#pricing" className="hover:text-[#0052FF]">{t.pricing}</a>
        </nav>
